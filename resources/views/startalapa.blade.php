...
<!-- <div class="container">
  ...
  <div class="row">
		<!-- <div class="col-lg-4 col-md-6 col-sm-6" style="padding: 15px; background-color: gray">
         ...
         @foreach ( $galadarbaarticles as $galadarbaarticle)
         <div class="col-lg-4 col-md-6 col-sm-6" style="padding: 15px; background-color: gray">
            	<div class="thumbnail" style="padding: 15px">
          <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="/backimg.jpg" alt="Card image cap">
              <div class="card-body">
                <h2 class="card-title">{{ $galadarbaarticle->head }}</h2>
                <p class="card-text">{{ $galadarbaarticle->body }}</p>
                <a href="/blogaieraksts/{{ $galadarbaarticle->id }}" class="btn btn-primary">Go to Ieraksts</a>
              </div>
            </div>
		      </div>
          </div>
...
<h2 style="padding: 30px; color: white; background-color: black; border-radius: 25px; margin-top:50px; margin-bottom:50px">You can post an article, if you're logged in!</h2>
...
<h2 style="padding: 30px; color: white; background-color: black; border-radius: 25px; margin-top:50px; margin-bottom:50px">Post your own article</h2>

<form method="POST">
{{ csrf_field() }}
  <h4 style="margin: 10px; color: black">Name of the article:</h4>
<input type="text" name="head" style="width: 240px">
<h4 style="margin: 10px; color: black">Write article:</h4>
<textarea name="body" class="form-control" id="bodytextarea" rows="10" placeholder="Write something that doesn't make sense"></textarea>
