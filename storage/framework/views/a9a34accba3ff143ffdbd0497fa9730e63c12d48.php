...
<div class="container">
    ...
    <form style="padding-top: 100px" method="POST">
        <?php echo e(csrf_field()); ?>
            ...
            First name:<br>
            <input type="text" name="firstname" placeholder="First name" style="width: 240px" class="form-control"><br>
            Last name:<br>
            <input type="text" name="lastname" placeholder="Last name" style="width: 240px" class="form-control"><br>
         
                E-mail:<br>
                <input type="email" name="email" placeholder="E-mail" style="width: 240px" class="form-control"><br>
           
                Text:<br>
                <textarea type="text" name="text" placeholder="Text area" style="height: 100px; width: 240px" class="form-control"></textarea><br>
